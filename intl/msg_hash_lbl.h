...
MSG_HASH(MENU_ENUM_LABEL_CORE_OPTIONS,
      "core_options")
MSG_HASH(MENU_ENUM_LABEL_KBD_BIND_ENTRY,
      "kbd_bind_entry")
MSG_HASH(MENU_ENUM_LABEL_BIND_ENTRY,
      "bind_entry")
...
MSG_HASH(MENU_ENUM_LABEL_DEFERRED_DROPDOWN_BOX_LIST_PORT_REMAP_BIND,
      "deferred_dropdown_box_list_port_remap_bind")
MSG_HASH(MENU_ENUM_LABEL_DEFERRED_DROPDOWN_BOX_LIST_PORT_REMAP_KBD_BIND,
      "deferred_dropdown_box_list_port_remap_kbd_bind")
